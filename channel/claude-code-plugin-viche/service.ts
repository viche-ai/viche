...
export type PhoenixChannel = any;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export async function connectAndRegisterWithRetry(server: Server): Promise<void> {
...
export function getActiveChannel(): PhoenixChannel | null {
...
export function getRegistryChannels(): Map<string, PhoenixChannel> {
